...
class GirlfriendGalleryScreen extends StatefulWidget {
  final String girlfriendId;

  const GirlfriendGalleryScreen({
    super.key,
    required this.girlfriendId,
  });

  @override
  State<GirlfriendGalleryScreen> createState() => _GirlfriendGalleryScreenState();
}

class _GirlfriendGalleryScreenState extends State<GirlfriendGalleryScreen> {
  ...
  Future<void> _loadGallery() async {
    ...
    try {
      ...
      final images = await _girlfriendService.getGirlfriendGallery(widget.girlfriendId);
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => _ImageViewerScreen(
          images: _images,
          initialIndex: index,
          girlfriendName: _girlfriend?.name ?? 'Gallery',
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(_girlfriend?.name ?? 'Gallery'),
        actions: [
          IconButton(
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Chiedi a ${_girlfriend?.name ?? 'lei'} di inviarti delle foto!',
                        style: TextStyle(
                          color: Colors.grey[700],
                          fontSize: 14,
                        ),

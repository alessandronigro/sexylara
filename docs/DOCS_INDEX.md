...
### 📱 [FEED_SOCIAL_SYSTEM.md](./FEED_SOCIAL_SYSTEM.md) (NEW - 25 Nov 2025)
**Documentazione completa Feed Social**

**Contenuto**:
- Database structure (tabelle feed)
- Backend API endpoints
- Flutter implementation (Service, Models, Widgets, Screens)
- User flow completo
- Bug fixes implementati
- Deployment status

**Quando leggerlo**: Per comprendere il sistema di feed sociale e come pubblicare/interagire con i post NPC

...
### 4. **Documentazione**
- ✅ README completo (`backend/ai/README.md`)
...
2. Vai su SQL Editor
3. Copia TUTTO il contenuto di backend/ai/schema.sql
...
# Vai su Supabase e esegui backend/ai/schema.sql
```
...
**Domande? Problemi?**
Controlla `backend/ai/README.md` per dettagli completi.
